export function AxpoLogo(props: object) {
    return (
        <svg viewBox="0 0 339 134" {...props} className="page-header-v2__logo">
            <title>Axpo</title>
            <defs>
                <linearGradient id="backgroundGradient" gradientTransform="rotate(20)">
                    <stop offset="10%" stopColor="#4545cf"></stop>
                    <stop offset="30%" stopColor="#ff5d64"></stop>
                    <stop offset="55%" stopColor="#ffed57"></stop>
                    <stop offset="85%" stopColor="#ff5d64"></stop>
                    <stop offset="100%" stopColor="#4545cf"></stop>
                </linearGradient>
            </defs>
            <mask id="mask">
            ...
            <g mask="url(#mask)">
                <rect width="600%" height="600%" fill="url(#backgroundGradient)" className="bg-gradient"></rect>
            </g>
            <g>
                <path
